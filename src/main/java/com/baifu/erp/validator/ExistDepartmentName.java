...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = {ExistDepartmentName.ExistDepartmentNameValidator.class})
public @interface ExistDepartmentName {

  String message() default "该部门不存在";

  Class<?>[] groups() default {};

  Class<? extends Payload>[] payload() default {};

  class ExistDepartmentNameValidator implements ConstraintValidator<ExistDepartmentName, String> {
    @Override
